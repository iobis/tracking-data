...
ggplot() +
  ...
  geom_point(data = imos_acoustic, aes(x = decimalLongitude, y = decimalLatitude), size = 1, stroke = 0.5, alpha = 0.3, colour = "#FF368B") +
  geom_point(data = imos_acoustic_binned, aes(x = decimalLongitude, y = decimalLatitude), size = 1, stroke = 0.5, alpha = 0.3, colour = "#0000CD") +
  xlab("Longitude") +
  ylab("Latitude") 
```
